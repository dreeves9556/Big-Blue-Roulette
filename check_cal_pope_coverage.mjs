...
// Focus on Calipari and Pope eras
const targetEras = ['calipari', 'pope'];
...
console.log('Total players in Calipari and Pope eras:', playersInTargetEras.length);
...
await fs.writeFile('./missing_cal_pope_players.json', JSON.stringify(missingPlayers, null, 2));
console.log('Missing players list saved to missing_cal_pope_players.json');
